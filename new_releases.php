...
<html lang="en">
	...
	<body>
      ...
      <header id="videohead-pro" class="sticky-header">
		...
		<div class="dashboard-container animated zoomInDown">
		 <br><h4 class="heading-extra-margin-bottom">New Releases</h4>
      ...
      <div class="carousel-caption" style="margin-bottom:240px; padding-left:200px;">
	  <a class="progression" href="https://drive.google.com/file/d/1q-is9B1WGyZz3cKk29JN9pd1vh5wJJLH/view?usp=sharing"><i class="fas fa-play"></i></a>
			...
			<b><br><h6 class="heading-extra-margin-bottom">Animation</h6></b>

			<div class="row">
					<div class="col-4 col-md-6 col-lg-4 col-xl-3">
				...
				<b><br><h6 class="heading-extra-margin-bottom">Tv_Series</h6></b>
				<div class="row">
					<div class="col-4 col-md-6 col-lg-4 col-xl-3">
						<div class="item-listing-container-skrn">
					...
					<div class="col-4 col-md-6 col-lg-4 col-xl-3">
						<div class="item-listing-container-skrn">
							...
							<div class="item-listing-text-skrn">
								<div class="item-listing-text-skrn-vertical-align"><h6><a href="dashboard-movie-profile.html">The New masquerade</a></h6>
							      <div
							        class="circle-rating-pro"
							        data-value="0.86"
							        data-animation-start-value="0.86"
				...
				<b><br><h6 class="heading-extra-margin-bottom">Movies</h6></b>
				<div class="row">
					<div class="col-4 col-md-6 col-lg-4 col-xl-3">
						<div class="item-listing-container-skrn">
							<a href="https://drive.google.com/file/d/1BMmbgPwpQg4lagv9acl7k-ZtKzMPqHWJ/view?usp=sharing"><img src="images/lion_heart6.jpg" alt="Listing" style="height:200px; width:400px;"></a>
							<div class="item-listing-text-skrn">
								<div class="item-listing-text-skrn-vertical-align"><h6><a href="https://drive.google.com/file/d/1BMmbgPwpQg4lagv9acl7k-ZtKzMPqHWJ/view?usp=sharing">Lion Heart</a></h6>
							      <div
							        class="circle-rating-pro"
							        data-value="0.6"
							        data-animation-start-value="0.6"
							        ...
							        data-empty-fill="#ffe1e1"
							        data-reverse="true"
							      ><span style="color:#ff4141;">8.0</span></div>
								</div><!-- close .item-listing-text-skrn-vertical-align -->
							</div><!-- close .item-listing-text-skrn -->
						</div><!-- close .item-listing-container-skrn -->
					</div><!-- close .col -->
					...
					<div class="col-4 col-md-6 col-lg-4 col-xl-3">
						<div class="item-listing-container-skrn">
							<a href="dashboard-movie-profile.html"><img src="images/junior_boys.jpg" alt="Listing" style="height:200px; width:400px;" ></a>
							<div class="item-listing-text-skrn">
					...
					<div class="col-4 col-md-6 col-lg-4 col-xl-3">
						<div class="item-listing-container-skrn">
							<a href="https://drive.google.com/open?id=1NXN8SH3Z4-bdH5d-qJxKrFfoJFNYSkiM"><img src="images/figurine2.jpg" alt="Listing" style="height:200px; width:400px;"></a>
							<div class="item-listing-text-skrn">
								<div class="item-listing-text-skrn-vertical-align"><h6><a href="https://drive.google.com/open?id=1NXN8SH3Z4-bdH5d-qJxKrFfoJFNYSkiM">Figurine</a></h6>
							      <div
							        class="circle-rating-pro"
							        data-value="0.86"
							        data-animation-start-value="0.86"
					...
					<div class="col-4 col-md-6 col-lg-4 col-xl-3">
						<div class="item-listing-container-skrn">
							<a href="https://drive.google.com/open?id=1d9spqIz6OXk9R5AC_7tMvOmPa3BUjB9V"><img src="images/saworoide2.jpg" alt="Listing" style="height:200px; width:400px;"></a>
							<div class="item-listing-text-skrn">
								<div class="item-listing-text-skrn-vertical-align"><h6><a href="https://drive.google.com/open?id=1d9spqIz6OXk9R5AC_7tMvOmPa3BUjB9V">Saworoide</a></h6>
							      <div
							        class="circle-rating-pro"
							        data-value="0.72"
							        data-animation-start-value="0.72"
