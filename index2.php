	...
	<body>
		<header id="masthead-pro">
			<div class="container-fluid">
				...
				<h1><a href="index.html"><img src="images/cere.png" alt="Logo"></a></h1>
				...
				<a href="login.php"><button class="btn btn-header-pro noselect" data-toggle="modal" data-target="#LoginModal" role="button">Sign In</button></a>
				
				<button class="btn btn-header-pro noselect" data-toggle="modal" data-target="#LoginModal" role="button">Sign Up</button>
		...
		<div class="flexslider progression-studios-slider">
	      <ul class="slides">
				<li class="progression_studios_animate_in">
					<div class="progression-studios-slider-image-background" style="background-image:url(images/bg.jpg);">
				...
				<li class="progression_studios_animate_right">
					<div class="progression-studios-slider-image-background" style="background-image:url(images/bg1.jpg); background-color:#111015;">
						<div class="progression-studios-slider-display-table">
							<div class="progression-studios-slider-vertical-align">
				...
				<li class="progression_studios_animate_left">
					<div class="progression-studios-slider-image-background" style="background-image:url(images/bg2.jpg);">
						<div class="progression-studios-slider-display-table">
							<div class="progression-studios-slider-vertical-align">
								...
								<div class="container">
									...
									<div class="progression-studios-slider-caption-width">
										<div class="progression-studios-slider-caption-align">
											<h2 class="text-white">Ultimate Video Theme</h2>
											<h6 class="text-white">Watch the largest collection of Movies and TV series anytime anywhere!</h6>
											<a class="btn btn-green-pro btn-slider-pro" href="signup-step1.html" role="button">Start Your Free Trial</a>
										</div><!-- close .progression-studios-slider-caption-align -->
									</div><!-- close .progression-studios-slider-caption-width -->
					...
					<div class="row">
						...
						<div class="col-md">
							<div class="pricing-table-col pricing-table-col-shadow-pro">
								<h6>STARTER</h6>
								<h2><sup>₦</sup>2000<span> / month</span></h2>
								<ul>
									<li>HD Available</li>
									<li>Watch on any Device</li>
						...
						<div class="col-md">
							<div class="pricing-table-col">
								<h6>PREMIUM</h6>
								<h2><sup>₦</sup>5000<span> / month</span></h2>
								<ul>
		...
		<footer id="footer-pro">
			<div class="container">
				<div class="row">
					<div class="col-md">
						<div class="copyright-text-pro">&copy; Cereflix 2019 | Keeping the Heritage</div>
					</div><!-- close .col -->
					<div class="col-md">
