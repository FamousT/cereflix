	...
	<body>
	  					 ...
	  					 <form class="registration-steps-form">
							 ...
							 <div class="clearfix"></div>
	  						 <div class="form-group last-form-group-continue">
	  							 <a href="signup-step3.php" class="btn btn-green-pro">Continue</a>
		...
		<footer id="footer-pro">
			<div class="container">
				<div class="row">
					<div class="col-md">
						<div class="copyright-text-pro">&copy; Copyright 2018 Cereflix. All Rights Reserved</div>
					</div><!-- close .col -->
					<div class="col-md">
		  ...
		  <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		    <div class="modal-content">
				 <div class="modal-header-pro">
					 <h2>Welcome Back</h2>
					 <h6>Sign in to your account to continue using Cereflix</h6>
				 </div>
